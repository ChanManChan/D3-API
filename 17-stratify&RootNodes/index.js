...
// hierarchical data with 'r', 'x', 'y' and 'value' properties attached to each node
const rootNode = stratify(data)
  .sum(d => d.amount)

const pack = d3.pack().size([960, 700]).padding(5)

// back to original data format (above array), we are ready to join our data array to shapes
const bubbleData = pack(rootNode).descendants()

// create ordinal scale (array of colors for range). Different color based on the depth of the item in that data
